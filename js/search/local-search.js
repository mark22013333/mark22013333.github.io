...
// Search
  ...
  // Hotkey: Ctrl+K / Cmd+K or / to open search
  const searchHotkeyFn = () => {
    const openAndFocus = () => {
      openSearch()
      // Ensure focus lands on input after animation completes
    ...
    document.addEventListener('keydown', e => {
      ...
      // "/" key to open search (only when not in an input/textarea)
